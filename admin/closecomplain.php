...
?>
<!-- main -->
<h2 align="center" style=" color:blue; text-shadow:2px 0px 6px grey; text-decoration:underline;">Close Complain</h2>
<table class="text-center table-bordered mt-4 table table-hover">
    ...
    <tr>
        ...
        <td><button style="background-color:green; color:white;" class="p-1"><?php echo $row['status'];  ?>losed Complain</button></td>
