...
?>
<!-- main -->
<h2 align="center" style=" color:blue; text-shadow:2px 0px 6px grey; text-decoration:underline;">Not Process Complain</h2>
<table class="text-center table-bordered mt-4 table table-hover">
    ...
    <tr> 
        ...
        <td><a href="status.php?id=<?php echo $row['cmpid'];?>" ><button style="background-color:red; color:white;" class="p-1"><?php echo $row['status'];  ?>ot Processed</button></a></td> 
