...
.col-sm-4
  ...
  <h4 align="center" style="color:blue"class="">Grievance Redressal Portal</h4>
    <h5 align="center" class="">Admin Login</h5>
...
<div class="row mt-4">
  ...
  <div class="row mt-4 text-center">
    ...
    <div id="login-ref" style="height:50px; margin-top:20px">
       <span class="back"><a href="forgetpass.php" style="font-size:18px;">Forget Password ?</a></span><br/>
       <span class="back" ><a href="../index.php"style="font-size:15px;"> Back to Home</a></span>
  </div>
